...
class FeedForward(nn.Module):
    """
    Implement the following network structure
...
class NNModel:
    ...
    def view_batch(self):
        ...
        image_numpy = np.transpose(image.numpy().reshape(8,8,28,28), (0,2,1,3)).reshape(8*28, 8*28)
        label_numpy = label.numpy().reshape(8,8)
